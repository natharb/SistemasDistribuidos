...
public class GenericDAO<T> implements Serializable {
	...
	// Fabrica de entity manages, pois cada entidade eh uma conexao com o BD.
	private static final EntityManagerFactory emf = Persistence
			.createEntityManagerFactory("my-app");

	// Criando objeto para criar conexao utilizando hibernate.
	@Inject
	...
	// Metodos de conexao com BD com hibernate.
	...
	public T find(Class<T> entidade, int entityId) {
		return em.find(entidade, entityId);
		
	}

//	public T findReferenceOnly(int entityID) {
//		return em.getReference(entidade, entityID);
//	}
